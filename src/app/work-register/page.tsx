        ...
        <DashboardLayout>
            <div className="space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Work Register</h1>
                        <p className="text-slate-500 mt-1">Track work orders, job cards and workshop progress.</p>
                    </div>
