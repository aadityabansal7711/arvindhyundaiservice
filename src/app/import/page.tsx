...
import { Upload, FileUp, CheckCircle2, AlertTriangle, Loader2, Download } from "lucide-react";
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="space-y-3">
                    ...
                    <p className="text-slate-500">
                        Download the Excel format, fill in details for RO, claim, approval, and parts sheets, then upload it to
                        bulk-create and update ROs.
                    </p>
                    <button
                        type="button"
                        onClick={handleDownloadTemplate}
                        className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-xl text-sm font-semibold shadow-sm hover:bg-slate-800 transition-colors"
                    >
                    ...
                    <div className="bg-white p-8 rounded-2xl border-2 border-dashed border-slate-200 hover:border-blue-400 transition-colors group">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm text-slate-500 mt-1">Supports .xlsx, .xls formats</p>
                            </div>
                            <input
                                type="file"
                                id="excel-upload"
                        ...
                        <div className="bg-emerald-50 border border-emerald-200 p-6 rounded-2xl space-y-4">
                            ...
                            {result.errorCount > 0 && (
                                <p className="text-sm text-emerald-700 italic">
                                    Check the audit log for details on skipped rows.
                                </p>
                            )}
                        </div>
                    )}
